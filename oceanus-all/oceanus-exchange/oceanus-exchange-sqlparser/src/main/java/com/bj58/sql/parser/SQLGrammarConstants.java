...
interface SQLGrammarConstants {
  ...
  int XMLQUERY = 393;
  /** RegularExpression Id. */
  int XMLSERIALIZE = 394;
  /** RegularExpression Id. */
  int Z_ORDER_LAT_LON = 395;
  /** RegularExpression Id. */
  int AFTER = 396;
  /** RegularExpression Id. */
  int BEFORE = 397;
  ...
  int MEDIUMTEXT = 440;
  /** RegularExpression Id. */
  int MESSAGE_LOCALE = 441;
  /** RegularExpression Id. */
  int METHOD = 442;
  /** RegularExpression Id. */
  int MICROSECOND = 443;
  /** RegularExpression Id. */
  int MINUTE_MICROSECOND = 444;
  /** RegularExpression Id. */
  int MINUTE_SECOND = 445;
  /** RegularExpression Id. */
  int MODE = 446;
  /** RegularExpression Id. */
  int MYSQL_DUMP = 447;
  ...
  int COLON = 522;
  /** RegularExpression Id. */
  int DOUBLE_COLON = 523;
  /** RegularExpression Id. */
  int SEMICOLON = 524;
  /** RegularExpression Id. */
  int LESS_THAN_OPERATOR = 525;
  /** RegularExpression Id. */
  int LESS_THAN_OR_EQUALS_OPERATOR = 526;
  /** RegularExpression Id. */
  int EQUALS_OPERATOR = 527;
  /** RegularExpression Id. */
  int NOT_EQUALS_OPERATOR = 528;
  /** RegularExpression Id. */
  int NOT_EQUALS_OPERATOR2 = 529;
  /** RegularExpression Id. */
  int GREATER_THAN_OPERATOR = 530;
  /** RegularExpression Id. */
  int GREATER_THAN_OR_EQUALS_OPERATOR = 531;
  /** RegularExpression Id. */
  int QUESTION_MARK = 532;
  /** RegularExpression Id. */
  int UNDERSCORE = 533;
  /** RegularExpression Id. */
  int LEFT_BRACKET = 534;
  /** RegularExpression Id. */
  int RIGHT_BRACKET = 535;
  /** RegularExpression Id. */
  int DOUBLE_LESS = 536;
  /** RegularExpression Id. */
  int DOUBLE_GREATER = 537;
  /** RegularExpression Id. */
  int FIELD_REFERENCE = 538;
  /** RegularExpression Id. */
  int ASTERISK_ASTERISK = 539;
  /** RegularExpression Id. */
  int CONCATENATION_OPERATOR = 540;
  /** RegularExpression Id. */
  int DOUBLE_AMPERSAND = 541;
  /** RegularExpression Id. */
  int IDENTIFIER = 542;
  /** RegularExpression Id. */
  int DOLLAR_N = 543;
  ...
  int DIGIT = 548;
  /** RegularExpression Id. */
  int BACKQUOTED_IDENTIFIER = 549;
  /** RegularExpression Id. */
  int DOUBLEQUOTED_IDENTIFIER = 551;
  /** RegularExpression Id. */
  int DOUBLEQUOTED_STRING = 552;
  /** RegularExpression Id. */
  int ESCAPEQUOTED_STRING = 554;
  /** RegularExpression Id. */
