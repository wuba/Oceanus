...
import com.bj58.oceanus.core.loadbalance.RandomWeightDispatcher;
 ...
 */
public class SwapRandomWeightDispatcher extends RandomWeightDispatcher implements Dispatcher, Swapable{
	
	static Logger logger = LoggerFactory.getLogger(SwapRandomWeightDispatcher.class);
